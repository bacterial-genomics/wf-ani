...
For further information/help, please consult the [wf-ani documentation](https://github.com/gregorysprenger/wf-ani/docs/usage.md) and don't hesitate to create an issue for any clarifications!
...
- Open the repo in [Codespaces](https://github.com/gregorysprenger/wf-ani/codespaces)
- Tools installed
  - nf-core
  - Nextflow
